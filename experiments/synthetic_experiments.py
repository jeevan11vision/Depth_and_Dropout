...
def argument_parser():
    ...
    parser.add_argument("--truncation_level", type=int, default=50,
    ...
    parser.add_argument("--b_prior", type=float, default=10.1,
...
with tqdm(range(args.epochs)) as tq:
    for epoch in tq:
        ...
        tq.set_postfix({'Tr. loss': f'{train_loss:.6f}', 'KL Beta': f'{kl_loss:.6f}', 'Depth': f'{threshold}'})
...
alpha_beta = {'alpha': a_k,
              'beta': b_k}
torch.save(alpha_beta, f'results/alpha_beta_{run_id}.pt')
